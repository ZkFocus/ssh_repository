...
public class ModelAttributeController {
	 ...
	 */
	@ModelAttribute
	public User getUser(@RequestParam(name="name",required=false) String name){
		if(name!=null){
	...
	@RequestMapping(name="testModelAttributtes",method=RequestMethod.GET)
	public String testModelAttributtes(){
		return "update";
	}
	
	@RequestMapping(name="testUpdate",method=RequestMethod.POST)
